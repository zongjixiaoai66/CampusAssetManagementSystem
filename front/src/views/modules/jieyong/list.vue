        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '开始借用数量' : ''">
                        <el-input v-model="searchForm.jieyongNumberStartSearch"
                               placeholder="请输入开始借用数量" clearable></el-input>
                        </el-form-item>
                        <el-form-item :label="contents.inputTitle == 1 ? '' : ''">
                        =》
                        </el-form-item>
                        <el-form-item :label="contents.inputTitle == 1 ? '结束借用数量' : ''">
                        <el-input v-model="searchForm.jieyongNumberEndSearch"
                               placeholder="请输入结束借用数量" clearable></el-input>
                    </el-form-item>
                 
                     <el-form-item :label="contents.inputTitle == 1 ? '是否归还' : ''">
                        <el-select v-model="searchForm.guihuanTypes" placeholder="请选择是否归还">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoyuanzichan/upload/jieyongMuBan.xls"
                        >批量导入资产借用数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('jieyong','导入导出')"
                            ...
                            >批量导入资产借用数据</el-button>
                        </el-upload>
                        &nbsp;
                        <!-- 导出excel -->
                        <download-excel v-if="isAuth('jieyong','导入导出')" style="display: inline-block" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "jieyong.xls">
                            <!-- 导出excel -->
                            <el-button
                                    type="success"
                                    icon="el-icon-download"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="role == '用户' && scope.row.guihuanTypes == 1" type="primary" icon="el-icon-edit" size="mini" @click="guihuan(scope.row.id)">归还</el-button>
                            <el-button v-if="isAuth('jieyong','删除')" type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
